...
class Client(DistributedTrainingDevice):
    ...
    def train_cnn(self, server, m, iter):
        ...
        if self.args.method == 'fedciw':
            ...
            self.alpha = self.args.alpha * pow(self.args.lr_decay, iter)
            print(self.alpha / self.variance_prior)
        ...
        for j in range(self.args.local_ep):
            ...
            for i in range(self.local_epoch):
                ...
                if self.args.method == 'fedciw':
                    ...
                    scale(target= self.prior_buffer, scaling = self.alpha / self.variance_prior)
